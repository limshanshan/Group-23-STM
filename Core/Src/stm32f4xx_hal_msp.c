...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC3     ------> ADC1_IN13
    */
    HAL_GPIO_DeInit(Left_IR_V0_GPIO_Port, Left_IR_V0_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC2     ------> ADC2_IN12
    */
    HAL_GPIO_DeInit(Right_IR_V0_GPIO_Port, Right_IR_V0_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(MotorA_CH1_GPIO_Port, MotorA_CH1_Pin);

    HAL_GPIO_DeInit(MotorA_CH2_GPIO_Port, MotorA_CH2_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, MotorB_CH1_Pin|MotorB_CH2_Pin);
